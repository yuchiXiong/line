...
const NotFoundPage: React.FC = () => {
  ...
  return (
    <div className="justify-center min-h-screen py-24 bg-gray-100">
      <center className="m-auto">
        <svg
          className="emoji-404 "
          enableBackground="new 0 0 226 249.135"
          height="249.135" id="Layer_1"
          overflow="visible"
          version="1.1"
        ...
        <div className="mt-4 tracking-widest ">
          <span className="block text-6xl text-gray-500"><span>4  0  4</span></span>
          <span className="text-xl text-gray-500">哦豁，服务器菌走丢了～</span>
        </div>
      </center>

    ...
    <>
      ...
      <section className="w-full h-screen flex flex-wrap items-center justify-center">
        <div className="lg:w-2/6 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col w-full">
          <h2 className="text-gray-900 text-lg font-medium title-font mb-5">注册</h2>
          ...
          <div className="relative mb-4">
            <label htmlFor="password" className="leading-7 text-sm text-gray-600">确认密码</label>
            <input
              type="password"
              id="confirm-password"
          ...
          <button className="text-white bg-green-600 border-0 py-2 px-8 focus:outline-none hover:bg-green-700 rounded text-lg">注册</button>
          <p className="text-xs text-gray-500 mt-3">已有账户？<Link href="/account/login" className='text-green-600 text-base'>立即登录</Link></p>
        </div>
      </section>
    </>
  )
